...
from api.dependency.current_user import get_firebase_user_from_token
...
async def get_me_info(current_user: Annotated[dict, Depends(get_firebase_user_from_token)],
...
async def partial_update_user(current_user: Annotated[dict, Depends(get_firebase_user_from_token)],
